...
public class BirthdayService {
    ...
    public void sendGreetings(String fileName, XDate xDate, String smtpHost, int smtpPort)
        ...
        while ((str = in.readLine()) != null) {
            ...
            Employee employee = new Employee(employeeData[1], employeeData[0], employeeData[2],
                employeeData[3]);
    ...
    private void sendMessage(String smtpHost, int smtpPort, String sender, String subject,
